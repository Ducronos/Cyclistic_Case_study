...
p1/p2
```
  2020 data shows the same shape of the graph with high concentration of the data on the left compare to 2019 data, especially with casual riders shape.
